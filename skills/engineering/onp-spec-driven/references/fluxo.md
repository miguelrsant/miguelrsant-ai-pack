...
o pacote npm `@onovoprogramador/onp-spec` (modo CI). O caminho do motor varia
conforme o agente: `.claude/skills/`, `.agents/skills/` ou `skills/*/onp-spec-driven/`:

```yaml
- run: node skills/engineering/onp-spec-driven/scripts/onp-spec.mjs verify entrega-dever-casa
- run: node skills/engineering/onp-spec-driven/scripts/onp-spec.mjs audit --ci
```
